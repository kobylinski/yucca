<script lang="ts">
	...
	const faviconDefault = `data:image/svg+xml,${encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 120 120"><circle cx="60" cy="60" r="42" fill="none" stroke="#e11d48" stroke-width="8"/><g transform="translate(60 60) scale(1.0) translate(-61 -65)"><g transform="translate(60 106) rotate(-30)"><path fill="#e11d48" d="M -7 0 C -6.4 -25.2, -2.9 -48, 0 -60 C 2.9 -48, 6.4 -25.2, 7 0 Z"/></g><g transform="translate(60 106) rotate(-6)"><path fill="#e11d48" d="M -8 0 C -7.4 -34.4, -3.4 -65.6, 0 -82 C 3.4 -65.6, 7.4 -34.4, 8 0 Z"/></g><g transform="translate(60 106) rotate(15)"><path fill="#e11d48" d="M -7.4 0 C -6.8 -30.2, -3.1 -57.6, 0 -72 C 3.1 -57.6, 6.8 -30.2, 7.4 0 Z"/></g><g transform="translate(60 106) rotate(39)"><path fill="#e11d48" d="M -6 0 C -5.5 -21.8, -2.5 -41.6, 0 -52 C 2.5 -41.6, 5.5 -21.8, 6 0 Z"/></g></g></svg>')}`;
	const faviconPending = `data:image/svg+xml,${encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 120 120"><circle cx="60" cy="60" r="42" fill="none" stroke="#f97316" stroke-width="8"/><g transform="translate(60 60) scale(1.0) translate(-61 -65)"><g transform="translate(60 106) rotate(-30)"><path fill="#f97316" d="M -7 0 C -6.4 -25.2, -2.9 -48, 0 -60 C 2.9 -48, 6.4 -25.2, 7 0 Z"/></g><g transform="translate(60 106) rotate(-6)"><path fill="#f97316" d="M -8 0 C -7.4 -34.4, -3.4 -65.6, 0 -82 C 3.4 -65.6, 7.4 -34.4, 8 0 Z"/></g><g transform="translate(60 106) rotate(15)"><path fill="#f97316" d="M -7.4 0 C -6.8 -30.2, -3.1 -57.6, 0 -72 C 3.1 -57.6, 6.8 -30.2, 7.4 0 Z"/></g><g transform="translate(60 106) rotate(39)"><path fill="#f97316" d="M -6 0 C -5.5 -21.8, -2.5 -41.6, 0 -52 C 2.5 -41.6, 5.5 -21.8, 6 0 Z"/></g></g></svg>')}`;
	...
	{:else}
		...
		<div class="mt-8 flex w-full max-w-4xl items-center justify-between px-8">
			...
			<div class="flex flex-col items-end gap-2 text-muted-foreground text-xs">
				<div class="flex items-center gap-1.5 text-foreground"><svg viewBox="0 0 120 120" class="size-5"><circle cx="60" cy="60" r="42" fill="none" stroke="#E11D48" stroke-width="8"/><g transform="translate(60 60) scale(1.0) translate(-61 -65)"><g transform="translate(60 106) rotate(-30)"><path fill="#E11D48" d="M -7 0 C -6.4 -25.2, -2.9 -48, 0 -60 C 2.9 -48, 6.4 -25.2, 7 0 Z"/></g><g transform="translate(60 106) rotate(-6)"><path fill="#E11D48" d="M -8 0 C -7.4 -34.4, -3.4 -65.6, 0 -82 C 3.4 -65.6, 7.4 -34.4, 8 0 Z"/></g><g transform="translate(60 106) rotate(15)"><path fill="#E11D48" d="M -7.4 0 C -6.8 -30.2, -3.1 -57.6, 0 -72 C 3.1 -57.6, 6.8 -30.2, 7.4 0 Z"/></g><g transform="translate(60 106) rotate(39)"><path fill="#E11D48" d="M -6 0 C -5.5 -21.8, -2.5 -41.6, 0 -52 C 2.5 -41.6, 5.5 -21.8, 6 0 Z"/></g></g></svg><span class="font-bold leading-none" style="font-family:'Outfit',ui-sans-serif,sans-serif">yucca</span></div>
			</div>
		</div>
